...
local Tabs = {
    ...
    RaceV4 = Window:AddTab({ Title = "Race", Icon = "" }),
...
local job = Tabs.Sever:AddSection("Job Id")
...
local place = Tabs.Sever:AddSection("Place ID")
...
local Join = Tabs.Sever:AddSection("Join")

local inputjobid = nil
local Input_jobid = Tabs.Sever:AddInput("job id", {
    Title = "Input Job id",
    Description = "",
    Default = "Default",
    Placeholder = "Input ur job id",
    Numeric = false, 
    Finished = false,
})

Input_jobid:OnChanged(function(Value)
    inputjobid = Value
end)

Tabs.Sever:AddButton({
    Title = "Join Join job id",
    Description = "",
    Callback = function()
        if game.PlaceId == 2753915549 then
            game:GetService("TeleportService"):TeleportToPlaceInstance(2753915549, inputjobid, game:GetService("Players").LocalPlayer)
        elseif game.PlaceId == 4442272183 then
            game:GetService("TeleportService"):TeleportToPlaceInstance(4442272183, inputjobid, game:GetService("Players").LocalPlayer)
        elseif game.PlaceId == 7449423635 then
            game:GetService("TeleportService"):TeleportToPlaceInstance(7449423635, inputjobid, game:GetService("Players").LocalPlayer)
        end
    end
})

local cre = Tabs.Sever:AddSection("Credit")

Tabs.Sever:AddButton({
    Title = "Sever Discord",
    Description = "i am not owner",
    Callback = function()
        setclipboard("https://discord.gg/mFraFHPtWF")
    end
})

local Weapon = Tabs.Main:AddDropdown("Dropdown", {
    Title = "Dropdown",
...
local attackdropdown = Tabs.Main:AddDropdown("attackdropdown", {
    Title = "Attack List",
    Description = "",
    Values = AttackList,
    Multi = false,
...
local farmlist = {"Normal", "Auto Quest", "Nearest"}
FarmMode = "Normal"
local modefarm = Tabs.Main:AddDropdown("MultiDropdown", {
...
modefarm:OnChanged(function(Value)
    FarmMode = Value
end)

local ToggleFarm = Tabs.Main:AddToggle("ToggleFarm", 
{
    Title = "Auto Farm", 
    Description = "pls selection mode farm",
    Default = false
})
